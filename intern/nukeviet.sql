...
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, '0e9b6ae7da3bf95c20cdd65fc246a2b9', 'fa-solid fa-server'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, '765d1d6afab5ebd2527e17e36b63be31', 'fa-solid fa-user-gear'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, '8479a1da39d89e08afed124b0b559cb7', 'fa-solid fa-gears'),
(4, 'database', 'mod_database', 4, 1, 0, 0, 'a2b3bd74da1477a86213cb6c006c0f7e', 'fa-solid fa-database'),
(5, 'webtools', 'mod_webtools', 5, 1, 1, 0, 'cc0afac1ba4b913a3e6efc09af328ef9', 'fa-solid fa-toolbox'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, '5d84b03bcd470bd7c9afbe1a349d16b3', 'fa-brands fa-searchengin'),
(7, 'language', 'mod_language', 7, 1, 1, 0, 'fa96ad5c2a20b196c4224d31870acc01', 'fa-solid fa-language'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, 'e5aa07a663c4e0ec3f19e293a525171c', 'fa-solid fa-cubes'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, '8c82773278f132ffc1ae0ec0822c83d3', 'fa-solid fa-palette'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, '4aa7ae756c7fe2c2d50f34e24cba212f', 'fa-solid fa-cubes-stacked'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, 'aa7115a5121166fdc6b25abe24bf6aa9', 'fa-solid fa-folder-plus'),
(12, 'emailtemplates', 'mod_emailtemplates', 12, 1, 1, 0, 'dff60555a46c869cb9fb3b9f9e94ff45', 'fa-solid fa-at');
...
(1, 'Mid-page advertisement', 1, 1, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1724081655, 1724081655, 0, 0, 1, 1),
(2, 'Left-column advertisement', 2, 1, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'http://vinades.vn', '_blank', '', 1724081655, 1724081655, 0, 0, 1, 2);
...
('en', 'global', 'smtp_password', 'z6XREEQsdnJRI5JgOvixIw,,'),
...
('sys', 'global', 'ftp_user_pass', 'GhLmqKwJcaUI0oUgInjw7w,,'),
...
('sys', 'global', 'my_domains', 'devlau.local'),
...
('sys', 'global', 'session_prefix', 'nv4s_k968UJ'),
...
('vi', 'global', 'smtp_password', 's5U-IjMdnfCY675LQILo7w,,'),
...
('vi', 'news', 'copy_news', '0'),
('vi', 'news', 'copyright', '<p>Chú ý: Việc đăng lại bài viết trên ở website hoặc các phương tiện truyền thông khác mà không ghi rõ nguồn http://nukeviet.vn là vi phạm bản quyền</p>'),
('vi', 'news', 'elas_host', ''),
('vi', 'news', 'elas_index', ''),
...
('day', '17', 0, 0, 0, 0),
('day', '18', 0, 0, 0, 0),
('day', '19', 1724086139, 3, 3, 0),
('day', '20', 1724166077, 5, 5, 0),
('day', '21', 1724245830, 1, 1, 0),
('day', '22', 1724311579, 3, 3, 0),
...
INSERT INTO `nv4_emailtemplates` (`emailid`, `lang`, `module_file`, `module_name`, `id`, `sys_pids`, `pids`, `catid`, `time_add`, `time_update`, `send_name`, `send_email`, `send_cc`, `send_bcc`, `attachments`, `is_system`, `is_plaintext`, `is_disabled`, `is_selftemplate`, `mailtpl`, `default_subject`, `default_content`, `vi_title`, `vi_subject`, `vi_content`, `en_title`, `en_subject`, `en_content`) VALUES
(1, '', '', '', 1, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo từ website {$site_name}', 'Ban quản trị website {$site_name} xin thông báo:<br />Tài khoản quản trị của bạn tại website {$site_name} đã bị xóa vào {$time}{if not empty($note)} vì lý do: {$note}{/if}.<br />Mọi đề nghị, thắc mắc... xin gửi email đến địa chỉ <a href=\"mailto:{$email}\">{$email}</a>{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}', 'Thông báo tài khoản quản trị đã bị xóa', '', '', 'Notice that the administrator account has been deleted', 'Information from {$site_name} website', 'Administrator {$site_name} website notify:<br />Your administrator account in {$site_name} website deleted at {$time}{if not empty($note)}. Reason: {$note}{/if}.<br />If you have any questions... please email <a href=\"mailto:{$email}\">{$email}</a>{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}'),
(2, '', '', '', 2, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo từ website {$site_name}', 'Ban quản trị website {$site_name} xin thông báo:<br />Tài khoản quản trị của bạn tại website {$site_name} đã bị đình chỉ hoạt động vào {$time} vì lý do: {$note}.<br />Mọi đề nghị, thắc mắc... xin gửi email đến địa chỉ <a href=\"mailto:{$email}\">{$email}</a>{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}', 'Thông báo đình chỉ quản trị site', '', '', 'Notice of suspension of site administration', 'Information from {$site_name} website', 'Information from {$site_name} aministrators:<br />Your administrator account in {$site_name} is suspended at {$time} reason: {$note}.<br />If you have any questions... please email <a href=\"mailto:{$email}\">{$email}</a>{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}'),
(3, '', '', '', 3, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo từ website {$site_name}', 'Ban quản trị website {$site_name} xin thông báo:<br />Tài khoản quản trị của bạn tại website {$site_name} đã hoạt động trở lại vào {$time}.<br />Trước đó tài khoản này đã bị đình chỉ hoạt động vì lý do: {$note}{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}', 'Thông báo kích hoạt lại quản trị site', '', '', 'Notice of reactivation of site administration', 'Information from {$site_name} website', 'Information from {$site_name} aministrators:<br />Your administrator account in {$site_name} is reactive at {$time}.<br />Your account has been suspended before because: {$note}{if not empty($username)}<br/><br/>{$sig}<br/><br/>{$username}<br/>{$position}<br/>{$email}{/if}'),
(4, '', '', '', 4, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Định cấu hình Xác thực hai bước bằng Oauth đã hoàn tất', '{$greeting_user}<br /><br />Ban quản trị website {$site_name} xin thông báo:<br />Việc xác thực đăng nhập quản trị của bạn bằng Oauth đã được thiết lập thành công. Bạn có thể sử dụng tài khoản <strong>{$oauth_id}</strong> của nhà cung cấp <strong>{$oauth_name}</strong> để xác thực mỗi khi đăng nhập vào quản trị hệ thống.', 'Thông báo phương thức xác thực hai bước mới được thêm vào tài khoản quản trị', '', '', 'Notice that a new two-step authentication method has been added to the admin account', 'Configuring 2-step verification using Oauth done', '{$greeting_user}<br /><br />Administration of the site {$site_name} would like to inform:<br />Two-step authentication using Oauth in the admin panel has been successfully installed. You can use the account <strong>{$oauth_id}</strong> of the provider <strong>{$oauth_name}</strong> for authentication when you log into the site admin area.'),
(5, '', '', '', 5, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Định cấu hình Xác thực hai bước bằng Oauth đã bị hủy', '{$greeting_user}<br /><br />Ban quản trị website {$site_name} xin thông báo:<br />Theo yêu cầu của bạn, việc xác thực hai bước bằng Oauth đã hủy thành công. Bạn đã không thể sử dụng các tài khoản <strong>{$oauth_id}</strong> để xác thực đăng nhập vào quản trị hệ thống.', 'Thông báo tất cả phương thức xác thực hai bước đã bị xóa khỏi tài khoản quản trị', '', '', 'Notification that all two-step authentication methods have been removed from the admin account', 'Configuring Two-Step Authentication with Oauth has been canceled', '{$greeting_user}<br /><br />Administration of the site {$site_name} would like to inform:<br />At your request, 2-Step Verification using Oauth has been successfully canceled. From now on, you cannot use the accounts <strong>{$oauth_id}</strong> to authenticate in the site admin area.'),
(6, '', '', '', 6, '4', '', 2, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Định cấu hình Xác thực hai bước bằng Oauth đã bị hủy', '{$greeting_user}<br /><br />Ban quản trị website {$site_name} xin thông báo:<br />Theo yêu cầu của bạn, việc xác thực hai bước bằng Oauth đã hủy thành công. Bạn đã không thể sử dụng tài khoản <strong>{$oauth_id}</strong> của nhà cung cấp <strong>{$oauth_name}</strong> để xác thực đăng nhập vào quản trị hệ thống.', 'Thông báo phương thức xác thực hai bước đã bị xóa khỏi tài khoản quản trị', '', '', 'Notice that two-step authentication has been removed from the admin account', 'Configuring Two-Step Authentication with Oauth has been canceled', '{$greeting_user}<br /><br />Administration of the site {$site_name} would like to inform:<br />At your request, 2-Step Verification using Oauth has been successfully canceled. From now on, you cannot use the account <strong>{$oauth_id}</strong> of the provider <strong>{$oauth_name}</strong> to authenticate in the site admin area.'),
(7, '', '', '', 7, '5', '', 1, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Cảnh báo từ website {$site_name}', 'Hệ thống đã nhận được một số thông báo. Bạn hãy mở file đính kèm để xem chi tiết', 'Email tự động thông báo lỗi', '', '', 'Email auto-notification error', 'Error report from website {$site_name}', 'The system received some error messages. Please open the attached file for details.'),
(8, '', '', '', 8, '5', '', 1, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Email thử nghiệm', 'Đây là email thử nghiệm để kiểm tra cấu hình gửi mail. Đơn giản bạn hãy xóa nó đi!', 'Email gửi thử nghiệm để kiểm tra cấu hình gửi mail', '', '', 'Send test email to test email sending configuration', 'Test email', 'This is a test email to check the mail configuration. Simply delete it!'),
(1001, 'vi', 'news', 'news', 1, '5', '', 4, 1724081655, 0, '', '', '', '', '', 0, 0, 0, 0, '', 'Tin nhắn từ {$from_name}', 'Xin chào!<br />Bạn của bạn là {$from_name} mong muốn giới thiệu với bạn bài viết “{$post_name}” trên website {$site_name}{if not empty($message)} với lời nhắn:<br />{$message}{/if}.<br/>----------<br/><strong>{$post_name}</strong><br/>{$hometext}<br/><br/>Bạn có thể xem đầy đủ bài viết bằng cách click vào link bên dưới:<br /><a href=\"{$link}\" title=\"{$post_name}\">{$link}</a>', 'Gửi email giới thiệu bài viết cho bạn bè tại module news', '', '', 'Send an email introducing the article to friend at the news module', 'Message from {$from_name}', 'Hello!<br />Your friend {$from_name} would like to introduce to you the article “{$post_name}” on website {$site_name}{if not empty($message)} with the message:<br />{$message}{/if}.<br/>----------<br/><strong>{$post_name}</strong><br/>{$hometext}<br/><br/>You can view the full article by clicking on the link below:<br /><a href=\"{$link}\" title=\"{$post_name}\">{$link}</a>'),
(1002, 'vi', 'news', 'news', 2, '5', '', 4, 1724081655, 0, '', '', '', '', '', 0, 0, 0, 0, '', 'Cảm ơn bạn đã báo lỗi', 'Xin chào!<br />Ban quản trị website {$site_name} cảm ơn bạn đã gửi đến chúng tôi báo cáo lỗi trong nội dung bài viết. Lỗi mà bạn thông báo đã được chúng tôi sửa lại.<br />Hy vọng sẽ nhận được sự giúp đỡ tiếp theo của bạn trong tương lai.<br />Chúc bạn luôn mạnh khỏe, hạnh phúc và thành công!', 'Email cảm ơn người báo lỗi tại module news', '', '', 'Email thanking the person who reported the error at module news', 'Thank you for submitting an error report', 'Hello!<br />{$site_name} website administration thank you very much for submitting an error report in the content of the article of our website. We fixed the error you reported.<br />Hope to receive your next help in the future. Wish you always healthy, happy and successful!'),
(1003, 'vi', 'users', 'users', 1, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông tin kích hoạt tài khoản', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đang chờ kích hoạt. Để kích hoạt, bạn hãy click vào link dưới đây:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Các thông tin cần thiết:<br /><br />Tài khoản: {$username}<br />Email: {$email}<br /><br />Việc kích hoạt tài khoản chỉ có hiệu lực đến {$active_deadline}<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Kích hoạt tài khoản qua email', '', '', 'Account activation via email', 'Activate information', '{$greeting_user}<br /><br />Your account at website {$site_name} waitting to activate. To activate, please click link follow:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Account information:<br /><br />Username: {$username}<br />Email: {$email}<br /><br />Activate expired on {$active_deadline}<br /><br />This is email automatic sending from website {$site_name}.'),
(1004, 'vi', 'users', 'users', 2, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thư thông báo xóa tài khoản', '{$greeting_user}<br /><br />Chúng tôi rất lấy làm tiếc thông báo về việc tài khoản của bạn đã bị xóa khỏi website {$site_name}.', 'Thư thông báo xóa tài khoản', '', '', 'Email notification to delete account', 'Email notification to delete account', '{$greeting_user}<br /><br />We are so sorry to delete your account at website {$site_name}.'),
(1005, 'vi', 'users', 'users', 3, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Mã dự phòng mới', '{$greeting_user}<br /><br />Mã dự phòng cho tài khoản của bạn tại website {$site_name} đã được thay đổi. Dưới đây là mã dự phòng mới:<br /><br />{foreach from=$new_code item=code}{$code}<br />{/foreach}<br />Bạn chú ý giữ mã dự phòng an toàn. Nếu mất điện thoại và mất cả mã dự phòng bạn sẽ không thể truy cập vào tài khoản của mình được nữa.<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Gửi mã dự phòng mới', '', '', 'Send new backup code', 'New backup code', '{$greeting_user}<br /><br /> backup code to your account at the website {$site_name} has been changed. Here is a new backup code: <br /><br />{foreach from=$new_code item=code}{$code}<br />{/foreach}<br />You keep your backup safe. If you lose your phone and lose your backup code, you will no longer be able to access your account.<br /><br />This is an automated message sent to your e-mail from website {$site_name}. If you do not understand the content of this letter, simply delete it.'),
(1006, 'vi', 'users', 'users', 4, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Dưới đây là thông tin tài khoản:<br /><br />Bí danh: {$username}<br />Email: {$email}<br /><br />Vui lòng bấm vào đường dẫn dưới đây để đăng nhập:<br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo tài khoản đã được tạo khi thành viên đăng kí thành công tại form', '', '', 'Notification that the account has been created when the member successfully registers in the form', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. Your login information:<br /><br />Username: {$username}<br />Email: {$email}<br /><br />Please click the link below to log in:<br />URL: <a href=\"{$link}\">{$link}</a><br /><br />This is email automatic sending from website {$site_name}.'),
(1007, 'vi', 'users', 'users', 5, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Để đăng nhập vui lòng truy cập vào trang: <a href=\"{$link}\">{$link}</a> và click vào nút: Đăng nhập bằng {$oauth_name}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo tài khoản đã được tạo khi thành viên đăng kí thành công qua Oauth', '', '', 'Notification that the account has been created when the member successfully registers via Oauth', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. To log into your account please visit the page: <a href=\"{$link}\">{$link}</a> and press the button: Sign in with {$oauth_name}.<br /><br />This is email automatic sending from website {$site_name}.'),
(1008, 'vi', 'users', 'users', 6, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />Email: {$email}<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo tài khoản được trưởng nhóm khởi tạo', '', '', 'Notification of account created by group leader', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. Your login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />Email: {$email}<br /><br />This is email automatic sending from website {$site_name}.'),
(1009, 'vi', 'users', 'users', 7, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được khởi tạo. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />Mật khẩu: {$password}<br />{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.<br />{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.<br />{/if}<br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo tài khoản được quản trị khởi tạo', '', '', 'Notification of account created by administrator', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} has been created. Here are the logins:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />Password: {$password}<br />{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.<br />{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.<br />{/if}<br />This is an automated message sent to Your email box from website {$site_name}. If you do not understand the content of this letter, simply delete it.'),
(1010, 'vi', 'users', 'users', 8, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Mã xác minh chế độ an toàn', '{$greeting_user}<br /><br />Bạn đã gửi yêu cầu sử dụng chế độ an toàn tại website {$site_name}. Dưới đây là mã xác minh dùng cho việc kích hoạt hoặc tắt chế độ an toàn:<br /><br /><strong>{$code}</strong><br /><br />Mã xác minh này chỉ có tác dụng bật-tắt chế độ an toàn một lần duy nhất. Sau khi bạn tắt chế độ an toàn, mã xác minh này sẽ vô giá trị.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}.', 'Gửi mã xác minh khi người dùng bật/ tắt chế độ an toàn', '', '', 'Send verification code when user turns on/ off safe mode', 'Safe mode verification code', '{$greeting_user}<br /><br />You sent a request using safe mode in website {$site_name}. Below is a verifykey  for activating or off safe mode:<br /><br /><strong>{$code}</strong><br /><br />This verifykey only works on-off safe mode once only. After you turn off safe mode, this verification code will be worthless.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}.'),
(1011, 'vi', 'users', 'users', 9, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Hồ sơ của bạn đã được cập nhật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được cập nhật {if $send_newvalue}với {$label} mới là <strong>{$newvalue}</strong>{else}{$label} mới{/if}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}.', 'Thông báo các thay đổi về tài khoản vừa được người dùng thực hiện', '', '', 'Notify account changes just made by the user', 'Update account infomation success', '{$greeting_user}<br /><br />Your account on the website {$site_name} has been updated {if $send_newvalue}with new {$label}: <strong>{$newvalue}</strong>{else}new {$label}{/if}.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}.'),
(1012, 'vi', 'users', 'users', 10, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được cập nhật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được cập nhật. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}{if not empty($password)}<br />Mật khẩu: {$password}{/if}<br />{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.<br />{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.<br />{/if}<br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo các thay đổi về tài khoản vừa được quản trị thực hiện', '', '', 'Notify account changes just made by the administrator', 'Your account has been updated', '{$greeting_user}<br /><br />Your account at website {$site_name} has been updated. Here are the login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}{if not empty($password)}<br />Password: {$password}{/if}<br />{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.<br />{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.<br />{/if}<br />This is an automated message sent to your email from {$site_name}. If you do not understand the content of this letter, simply delete it.'),
(1013, 'vi', 'users', 'users', 11, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông tin kích hoạt thay đổi email', '{$greeting_user}<br /><br />Bạn đã gửi đề nghị thay đổi email của tài khoản người dùng trên website {$site_name}. Để hoàn tất thay đổi này, bạn cần xác nhận email mới bằng cách nhập Mã xác minh dưới đây vào ô tương ứng tại khu vực Sửa thông tin tài khoản:<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Mã này hết hạn vào {$deadline}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thư xác nhận thay đổi email tài khoản', '', '', 'Confirmation email to change account email', 'Activation information for changing email', '{$greeting_user}<br /><br />You sent a request to change the email address of the personal Account on the website {$site_name}. To complete this change, you must confirm your new email address by entering the verifykey below in the appropriate fields in the area Edit Account Information:<br /><br />Verifykey: <strong>{$code}</strong><br /><br />This key expires on {$deadline}.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}. If you do not understand anything about the contents of this letter, simply delete it.'),
(1014, 'vi', 'users', 'users', 12, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Yêu cầu tham gia nhóm', 'Xin chào trưởng nhóm <strong>{$group_name}</strong>,<br /><br /><strong>{$full_name}</strong> đã gửi yêu cầu tham gia nhóm <strong>{$group_name}</strong> do bạn đang quản lý. Vui lòng xét duyệt yêu cầu bằng cách nhấn vào <a href=\"{$link}\">liên kết này</a>.', 'Thông báo có yêu cầu tham gia nhóm', '', '', 'Notice asking to join the group', 'Request to join group', 'Hello leader <strong>{$group_name}</strong>,<br /><br /><strong>{$full_name}</strong> has sent the request to join the group <strong>{$group_name}</strong> you are managing. You need to approve this request!<br /><br />Please <a href=\"{$link}\"> visit this link </a> to approve membership.'),
(1015, 'vi', 'users', 'users', 13, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông tin kích hoạt tài khoản', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đang chờ kích hoạt. Để kích hoạt, bạn hãy click vào link dưới đây:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Các thông tin cần thiết:<br />Bí danh: {$username}<br />Email: {$email}<br />Mật khẩu: {$password}<br /><br />Việc kích hoạt tài khoản chỉ có hiệu lực đến {$active_deadline}<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Gửi lại thông tin kích hoạt tài khoản', '', '', 'Resend account activation information', 'Activate account', '{$greeting_user}<br /><br />Your account at website {$site_name} waitting to activate. To activate, please click link follow:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Account information:<br />Account: {$username}<br />Email: {$email}<br />Password: {$password}<br /><br />Activate expired on {$active_deadline}<br /><br />This is email automatic sending from website {$site_name}.'),
(1016, 'vi', 'users', 'users', 14, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Hướng dẫn tạo lại mật khẩu', '{$greeting_user}<br /><br />Bạn vừa gửi đề nghị thay đổi mật khẩu tài khoản người dùng tại website {$site_name}. Để thay đổi mật khẩu, bạn cần nhập mã xác minh dưới đây vào ô tương ứng tại khu vực thay đổi mật khẩu.<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Mã này chỉ được sử dụng một lần và trước thời hạn: {$deadline}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Hướng dẫn lấy lại mật khẩu thành viên', '', '', 'Instructions for retrieving member password', 'Guide password recovery', '{$greeting_user}<br /><br />You propose to change my login password at the website {$site_name}. To change your password, you will need to enter the verification code below in the corresponding box at the password change area.<br /><br />Verification code: <strong>{$code}</strong><br /><br />This code is only used once and before the deadline of {$deadline}.<br /><br />This letter is automatically sent to your email inbox from site {$site_name}. If you do not know anything about the contents of this letter, just delete it.'),
(1017, 'vi', 'users', 'users', 15, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Xác thực 2 bước đã tắt', '{$greeting_user}<br /><br />Theo yêu cầu của bạn, chúng tôi đã tắt tính năng Xác thực 2 bước cho tài khoản của bạn tại website {$site_name}.<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Thông báo xác thực hai bước đã gỡ thành công', '', '', 'Notice that two-step authentication has been successfully removed', '2-Step Verification is turned off', '{$greeting_user}<br /><br />At your request, we have turned off 2-Step Verification for your account at the {$site_name} website.<br /><br />This is email automatic sending from website {$site_name}.'),
(1018, 'vi', 'users', 'users', 16, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông tin tắt xác thực 2 bước', '{$greeting_user}<br /><br />Chúng tôi vừa nhận được yêu cầu tắt xác thực 2 bước cho tài khoản của bạn tại website {$site_name}. Nếu bạn là người gửi yêu cầu này, hãy sử dụng Mã xác minh dưới đây để tiến hành tắt:<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Hướng dẫn tắt xác thực hai bước khi quên mã', '', '', 'Instructions for turning off two-step authentication when forgetting code', 'Information about turning off 2-step verification', '{$greeting_user}<br /><br />We have received a request to turn off 2-step verification for your account at the {$site_name} website. If you sent this request yourself, please use the Verification Code below to proceed:<br /><br />Verification Code: <strong>{$code}</strong><br /><br />This is email automatic sending from website {$site_name}.'),
(1019, 'vi', 'users', 'users', 17, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được kết nối với tài khoản <strong>{$username}</strong> của bạn bởi trưởng nhóm.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo oauth được thêm vào tài khoản bởi trưởng nhóm', '', '', 'Notification oauth is added to the account by the team leader', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that a third party account <strong>{$oauth_name}</strong> has just been connected to your <strong>{$username}</strong> account by the group leader.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1020, 'vi', 'users', 'users', 18, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được kết nối với tài khoản <strong>{$username}</strong> của bạn. Nếu đây không phải là chủ ý của bạn, vui lòng nhanh chóng xóa nó khỏi tài khoản của mình bằng cách truy cập vào khu vực quản lý tài khoản bên thứ ba.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo oauth được thêm vào tài khoản bởi chính người dùng', '', '', 'Notification oauth is added to the account by the user themselves', 'Privacy Notice', '{$greeting_user}<br /><br />The third party account <strong>{$oauth_name}</strong> has just been connected to your <strong>{$username}</strong> account. If this was not your intention, please quickly remove it from your account by visiting the third party account management area.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1021, 'vi', 'users', 'users', 19, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản <strong>{$username}</strong> của bạn bởi trưởng nhóm.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi trưởng nhóm', '', '', 'Notification oauth is removed to the account by the team leader', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that the third party account <strong>{$oauth_name}</strong> has just been disconnected from your <strong>{$username}</strong> account by the group leader.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1022, 'vi', 'users', 'users', 21, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản <strong>{$username}</strong> của bạn. Nếu đây không phải là chủ ý của bạn, vui lòng nhanh chóng liên hệ với quản trị site để được giúp đỡ.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi chính người dùng', '', '', 'Notification oauth is removed to the account by the user themselves', 'Privacy Notice', '{$greeting_user}<br /><br />The third-party account <strong>{$oauth_name}</strong> has just been disconnected from your <strong>{$username}</strong> account. If this is not your intention, please quickly contact the site administrator for help.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1023, 'vi', 'users', 'users', 22, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thư xác minh email mới', 'Xin chào!<br /><br />Bạn đã gửi yêu cầu xác minh email: {$email}. Hãy chép mã dưới đây vào ô Mã xác minh trên site.<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Gửi mã xác minh email khi đăng nhập qua Oauth mà email trùng với tài khoản đã có', '', '', 'Send email verification code when logging in via Oauth and the email matches your existing account', 'New e-mail verification', 'Hello!<br /><br />You have sent a request to verify your email address: {$email}. Copy the code below and paste it into the Verification code box on the site.<br /><br />Verification code: <strong>{$code}</strong><br /><br />This is email automatic sending from website {$site_name}.'),
(1024, 'vi', 'users', 'users', 24, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. {if empty($oauth_name)}Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />{if not empty($password)}Mật khẩu: {$password}{/if}{else}Để đăng nhập vui lòng truy cập vào trang: <a href=\"{$link}\">{$link}</a> và click vào nút: <strong>Đăng nhập bằng {$oauth_name}</strong>.{if not empty($password)}<br /><br />Bạn cũng có thể đăng nhập theo cách thông thường với thông tin:<br />Bí danh: {$username}<br />Mật khẩu: {$password}{/if}{/if}{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.{/if}<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Email thông báo cho người dùng khi quản trị kích hoạt tài khoản', '', '', 'Email notifies users when the administrator activates the account', 'Your account has been created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. {if empty($oauth_name)}Your login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />{if not empty($password)}Password: {$password}{/if}{else}To log into your account please visit the page: <a href=\"{$link}\">{$link}</a> and press the button: <strong>Sign in with {$oauth_name}</strong>.{if not empty($password)}<br /><br />You can also log in using the usual method with the following information:<br />Username: {$username}<br />Password: {$password}{/if}{/if}{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.{/if}<br /><br />This is email automatic sending from website {$site_name}.'),
(1025, 'vi', 'users', 'users', 25, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', '{if $pass_reset eq 2}Khuyến cáo thay đổi mật khẩu truy cập{else}Cần thay đổi mật khẩu truy cập{/if}', '{$greeting_user}<br /><br />Ban quản trị website {$site_name} xin thông báo: Vì lý do bảo mật chúng tôi {if $pass_reset eq 2}khuyến cáo bạn nên{else}đề nghị bạn nhanh chóng{/if} thay đổi mật khẩu truy cập tài khoản của mình. Để thay đổi mật khẩu, trước hết bạn cần truy cập vào trang <a href=\"{$link}\">Quản lý tài khoản cá nhân</a>, chọn nút Thiết lập tài khoản, sau đó chọn nút Mật khẩu và làm theo hướng dẫn.', 'Email yêu cầu người dùng thay đổi mật khẩu', '', '', 'Email asking user to change password', '{if $pass_reset eq 2}Recommended account password change{else}Need to change account password{/if}', '{$greeting_user}<br /><br />The {$site_name} website administration informs: For security reasons, {if $pass_reset eq 2}we recommend that you{else}you need to{/if} change your account password as soon as possible. To change your password, you need to first visit the <a href=\"{$link}\">Manage Personal Account page</a>, select the Account Settings button, then the Password button, and follow the instructions.'),
(1026, 'vi', 'users', 'users', 26, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn vừa được tắt xác thực hai bước bởi quản trị viên. Chúng tôi gửi cho bạn email này để thông tin đến bạn.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý xác thực hai bước</a>', 'Thông báo đến người dùng xác thực hai bước đã được quản trị tắt', '', '', 'Notification to users that two-step authentication has been turned off by the administrator', 'Privacy Notice', '{$greeting_user}<br /><br />Your account has just had two-step authentication disabled by your administrator. We send you this email to inform you.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Manage two-step authentication</a>'),
(1027, 'vi', 'users', 'users', 20, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản của bạn bởi quản trị viên.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi quản trị', '', '', 'Notify users when administrators delete their third-party account', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that the third party account <strong>{$oauth_name}</strong> has just been disconnected from your account by an administrator. We send you this email to inform you.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1028, 'vi', 'users', 'users', 23, '3', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tất cả các tài khoản bên thứ ba vừa được ngắt kết nối khỏi tài khoản của bạn bởi quản trị viên.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Thông báo đến người dùng khi quản trị xóa tất cả Oauth của họ', '', '', 'Notify users when administrators delete all of their third-party accounts', 'Privacy Notice', '{$greeting_user}<br /><br />We inform you that all third party accounts have been disconnected from your account by an administrator.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>'),
(1029, 'vi', 'two-step-verification', 'two-step-verification', 1, '5', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa kích hoạt chức năng xác thực hai bước qua ứng dụng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, rất có thể tài khoản của bạn đã bị đánh cắp. Hãy liên hệ với quản trị site để được hỗ trợ', 'Thông báo bật xác thực hai bước cho tài khoản thành viên', '', '', 'Notice to enable two-step authentication for member accounts', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just enabled Two-Factor Authentication. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, your account is most likely stolen. Please contact the site administrator for assistance'),
(1030, 'vi', 'two-step-verification', 'two-step-verification', 2, '5', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa tắt chức năng xác thực hai bước qua ứng dụng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, mời kiểm tra lại thông tin cá nhân tại <a href=\"{$link}\">{$link}</a>', 'Thông báo tắt xác thực hai bước cho tài khoản thành viên', '', '', 'Notice to turn off two-step authentication for member accounts', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just disabled Two-Factor Authentication. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, please check your personal information at <a href=\"{$link}\">{$link}</a>'),
(1031, 'vi', 'two-step-verification', 'two-step-verification', 3, '5', '', 3, 1724081655, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa tạo lại mã dự phòng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, mời kiểm tra lại thông tin cá nhân tại <a href=\"{$link}\">{$link}</a>', 'Thông báo tạo lại mã dự phòng xác thực hai bước cho tài khoản thành viên', '', '', 'Notice of regenerating two-step authentication backup codes for member accounts', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just recreated the backup code. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, please check your personal information at <a href=\"{$link}\">{$link}</a>'),
(1032, 'en', 'news', 'news', 1, '5', '', 4, 1724661663, 0, '', '', '', '', '', 0, 0, 0, 0, '', 'Message from {$from_name}', 'Hello!<br />Your friend {$from_name} would like to introduce to you the article “{$post_name}” on website {$site_name}{if not empty($message)} with the message:<br />{$message}{/if}.<br/>----------<br/><strong>{$post_name}</strong><br/>{$hometext}<br/><br/>You can view the full article by clicking on the link below:<br /><a href=\"{$link}\" title=\"{$post_name}\">{$link}</a>', 'Gửi email giới thiệu bài viết cho bạn bè tại module news', 'Tin nhắn từ {$from_name}', 'Xin chào!<br />Bạn của bạn là {$from_name} mong muốn giới thiệu với bạn bài viết “{$post_name}” trên website {$site_name}{if not empty($message)} với lời nhắn:<br />{$message}{/if}.<br/>----------<br/><strong>{$post_name}</strong><br/>{$hometext}<br/><br/>Bạn có thể xem đầy đủ bài viết bằng cách click vào link bên dưới:<br /><a href=\"{$link}\" title=\"{$post_name}\">{$link}</a>', 'Send an email introducing the article to friend at the news module', '', ''),
(1033, 'en', 'news', 'news', 2, '5', '', 4, 1724661663, 0, '', '', '', '', '', 0, 0, 0, 0, '', 'Thank you for submitting an error report', 'Hello!<br />{$site_name} website administration thank you very much for submitting an error report in the content of the article of our website. We fixed the error you reported.<br />Hope to receive your next help in the future. Wish you always healthy, happy and successful!', 'Email cảm ơn người báo lỗi tại module news', 'Cảm ơn bạn đã báo lỗi', 'Xin chào!<br />Ban quản trị website {$site_name} cảm ơn bạn đã gửi đến chúng tôi báo cáo lỗi trong nội dung bài viết. Lỗi mà bạn thông báo đã được chúng tôi sửa lại.<br />Hy vọng sẽ nhận được sự giúp đỡ tiếp theo của bạn trong tương lai.<br />Chúc bạn luôn mạnh khỏe, hạnh phúc và thành công!', 'Email thanking the person who reported the error at module news', '', ''),
(1034, 'en', 'users', 'users', 1, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Activate information', '{$greeting_user}<br /><br />Your account at website {$site_name} waitting to activate. To activate, please click link follow:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Account information:<br /><br />Username: {$username}<br />Email: {$email}<br /><br />Activate expired on {$active_deadline}<br /><br />This is email automatic sending from website {$site_name}.', 'Kích hoạt tài khoản qua email', 'Thông tin kích hoạt tài khoản', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đang chờ kích hoạt. Để kích hoạt, bạn hãy click vào link dưới đây:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Các thông tin cần thiết:<br /><br />Tài khoản: {$username}<br />Email: {$email}<br /><br />Việc kích hoạt tài khoản chỉ có hiệu lực đến {$active_deadline}<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Account activation via email', '', ''),
(1035, 'en', 'users', 'users', 2, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Email notification to delete account', '{$greeting_user}<br /><br />We are so sorry to delete your account at website {$site_name}.', 'Thư thông báo xóa tài khoản', 'Thư thông báo xóa tài khoản', '{$greeting_user}<br /><br />Chúng tôi rất lấy làm tiếc thông báo về việc tài khoản của bạn đã bị xóa khỏi website {$site_name}.', 'Email notification to delete account', '', ''),
(1036, 'en', 'users', 'users', 3, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'New backup code', '{$greeting_user}<br /><br /> backup code to your account at the website {$site_name} has been changed. Here is a new backup code: <br /><br />{foreach from=$new_code item=code}{$code}<br />{/foreach}<br />You keep your backup safe. If you lose your phone and lose your backup code, you will no longer be able to access your account.<br /><br />This is an automated message sent to your e-mail from website {$site_name}. If you do not understand the content of this letter, simply delete it.', 'Gửi mã dự phòng mới', 'Mã dự phòng mới', '{$greeting_user}<br /><br />Mã dự phòng cho tài khoản của bạn tại website {$site_name} đã được thay đổi. Dưới đây là mã dự phòng mới:<br /><br />{foreach from=$new_code item=code}{$code}<br />{/foreach}<br />Bạn chú ý giữ mã dự phòng an toàn. Nếu mất điện thoại và mất cả mã dự phòng bạn sẽ không thể truy cập vào tài khoản của mình được nữa.<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Send new backup code', '', ''),
(1037, 'en', 'users', 'users', 4, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. Your login information:<br /><br />Username: {$username}<br />Email: {$email}<br /><br />Please click the link below to log in:<br />URL: <a href=\"{$link}\">{$link}</a><br /><br />This is email automatic sending from website {$site_name}.', 'Thông báo tài khoản đã được tạo khi thành viên đăng kí thành công tại form', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Dưới đây là thông tin tài khoản:<br /><br />Bí danh: {$username}<br />Email: {$email}<br /><br />Vui lòng bấm vào đường dẫn dưới đây để đăng nhập:<br />URL: <a href=\"{$link}\">{$link}</a><br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notification that the account has been created when the member successfully registers in the form', '', ''),
(1038, 'en', 'users', 'users', 5, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. To log into your account please visit the page: <a href=\"{$link}\">{$link}</a> and press the button: Sign in with {$oauth_name}.<br /><br />This is email automatic sending from website {$site_name}.', 'Thông báo tài khoản đã được tạo khi thành viên đăng kí thành công qua Oauth', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Để đăng nhập vui lòng truy cập vào trang: <a href=\"{$link}\">{$link}</a> và click vào nút: Đăng nhập bằng {$oauth_name}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notification that the account has been created when the member successfully registers via Oauth', '', '');
INSERT INTO `nv4_emailtemplates` (`emailid`, `lang`, `module_file`, `module_name`, `id`, `sys_pids`, `pids`, `catid`, `time_add`, `time_update`, `send_name`, `send_email`, `send_cc`, `send_bcc`, `attachments`, `is_system`, `is_plaintext`, `is_disabled`, `is_selftemplate`, `mailtpl`, `default_subject`, `default_content`, `vi_title`, `vi_subject`, `vi_content`, `en_title`, `en_subject`, `en_content`) VALUES
(1039, 'en', 'users', 'users', 6, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. Your login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />Email: {$email}<br /><br />This is email automatic sending from website {$site_name}.', 'Thông báo tài khoản được trưởng nhóm khởi tạo', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />Email: {$email}<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notification of account created by group leader', '', ''),
(1040, 'en', 'users', 'users', 7, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account was created', '{$greeting_user}<br /><br />Your account at website {$site_name} has been created. Here are the logins:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />Password: {$password}<br />{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.<br />{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.<br />{/if}<br />This is an automated message sent to Your email box from website {$site_name}. If you do not understand the content of this letter, simply delete it.', 'Thông báo tài khoản được quản trị khởi tạo', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được khởi tạo. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />Mật khẩu: {$password}<br />{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.<br />{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.<br />{/if}<br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notification of account created by administrator', '', ''),
(1041, 'en', 'users', 'users', 8, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Safe mode verification code', '{$greeting_user}<br /><br />You sent a request using safe mode in website {$site_name}. Below is a verifykey  for activating or off safe mode:<br /><br /><strong>{$code}</strong><br /><br />This verifykey only works on-off safe mode once only. After you turn off safe mode, this verification code will be worthless.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}.', 'Gửi mã xác minh khi người dùng bật/ tắt chế độ an toàn', 'Mã xác minh chế độ an toàn', '{$greeting_user}<br /><br />Bạn đã gửi yêu cầu sử dụng chế độ an toàn tại website {$site_name}. Dưới đây là mã xác minh dùng cho việc kích hoạt hoặc tắt chế độ an toàn:<br /><br /><strong>{$code}</strong><br /><br />Mã xác minh này chỉ có tác dụng bật-tắt chế độ an toàn một lần duy nhất. Sau khi bạn tắt chế độ an toàn, mã xác minh này sẽ vô giá trị.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}.', 'Send verification code when user turns on/ off safe mode', '', ''),
(1042, 'en', 'users', 'users', 9, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Update account infomation success', '{$greeting_user}<br /><br />Your account on the website {$site_name} has been updated {if $send_newvalue}with new {$label}: <strong>{$newvalue}</strong>{else}new {$label}{/if}.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}.', 'Thông báo các thay đổi về tài khoản vừa được người dùng thực hiện', 'Hồ sơ của bạn đã được cập nhật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được cập nhật {if $send_newvalue}với {$label} mới là <strong>{$newvalue}</strong>{else}{$label} mới{/if}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}.', 'Notify account changes just made by the user', '', ''),
(1043, 'en', 'users', 'users', 10, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account has been updated', '{$greeting_user}<br /><br />Your account at website {$site_name} has been updated. Here are the login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}{if not empty($password)}<br />Password: {$password}{/if}<br />{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.<br />{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.<br />{/if}<br />This is an automated message sent to your email from {$site_name}. If you do not understand the content of this letter, simply delete it.', 'Thông báo các thay đổi về tài khoản vừa được quản trị thực hiện', 'Tài khoản của bạn đã được cập nhật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được cập nhật. Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}{if not empty($password)}<br />Mật khẩu: {$password}{/if}<br />{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.<br />{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.<br />{/if}<br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notify account changes just made by the administrator', '', ''),
(1044, 'en', 'users', 'users', 11, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Activation information for changing email', '{$greeting_user}<br /><br />You sent a request to change the email address of the personal Account on the website {$site_name}. To complete this change, you must confirm your new email address by entering the verifykey below in the appropriate fields in the area Edit Account Information:<br /><br />Verifykey: <strong>{$code}</strong><br /><br />This key expires on {$deadline}.<br /><br />These are automatic messages sent to your e-mail inbox from website {$site_name}. If you do not understand anything about the contents of this letter, simply delete it.', 'Thư xác nhận thay đổi email tài khoản', 'Thông tin kích hoạt thay đổi email', '{$greeting_user}<br /><br />Bạn đã gửi đề nghị thay đổi email của tài khoản người dùng trên website {$site_name}. Để hoàn tất thay đổi này, bạn cần xác nhận email mới bằng cách nhập Mã xác minh dưới đây vào ô tương ứng tại khu vực Sửa thông tin tài khoản:<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Mã này hết hạn vào {$deadline}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Confirmation email to change account email', '', ''),
(1045, 'en', 'users', 'users', 12, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Request to join group', 'Hello leader <strong>{$group_name}</strong>,<br /><br /><strong>{$full_name}</strong> has sent the request to join the group <strong>{$group_name}</strong> you are managing. You need to approve this request!<br /><br />Please <a href=\"{$link}\"> visit this link </a> to approve membership.', 'Thông báo có yêu cầu tham gia nhóm', 'Yêu cầu tham gia nhóm', 'Xin chào trưởng nhóm <strong>{$group_name}</strong>,<br /><br /><strong>{$full_name}</strong> đã gửi yêu cầu tham gia nhóm <strong>{$group_name}</strong> do bạn đang quản lý. Vui lòng xét duyệt yêu cầu bằng cách nhấn vào <a href=\"{$link}\">liên kết này</a>.', 'Notice asking to join the group', '', ''),
(1046, 'en', 'users', 'users', 13, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Activate account', '{$greeting_user}<br /><br />Your account at website {$site_name} waitting to activate. To activate, please click link follow:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Account information:<br />Account: {$username}<br />Email: {$email}<br />Password: {$password}<br /><br />Activate expired on {$active_deadline}<br /><br />This is email automatic sending from website {$site_name}.', 'Gửi lại thông tin kích hoạt tài khoản', 'Thông tin kích hoạt tài khoản', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đang chờ kích hoạt. Để kích hoạt, bạn hãy click vào link dưới đây:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Các thông tin cần thiết:<br />Bí danh: {$username}<br />Email: {$email}<br />Mật khẩu: {$password}<br /><br />Việc kích hoạt tài khoản chỉ có hiệu lực đến {$active_deadline}<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Resend account activation information', '', ''),
(1047, 'en', 'users', 'users', 14, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Guide password recovery', '{$greeting_user}<br /><br />You propose to change my login password at the website {$site_name}. To change your password, you will need to enter the verification code below in the corresponding box at the password change area.<br /><br />Verification code: <strong>{$code}</strong><br /><br />This code is only used once and before the deadline of {$deadline}.<br /><br />This letter is automatically sent to your email inbox from site {$site_name}. If you do not know anything about the contents of this letter, just delete it.', 'Hướng dẫn lấy lại mật khẩu thành viên', 'Hướng dẫn tạo lại mật khẩu', '{$greeting_user}<br /><br />Bạn vừa gửi đề nghị thay đổi mật khẩu tài khoản người dùng tại website {$site_name}. Để thay đổi mật khẩu, bạn cần nhập mã xác minh dưới đây vào ô tương ứng tại khu vực thay đổi mật khẩu.<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Mã này chỉ được sử dụng một lần và trước thời hạn: {$deadline}.<br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Instructions for retrieving member password', '', ''),
(1048, 'en', 'users', 'users', 15, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', '2-Step Verification is turned off', '{$greeting_user}<br /><br />At your request, we have turned off 2-Step Verification for your account at the {$site_name} website.<br /><br />This is email automatic sending from website {$site_name}.', 'Thông báo xác thực hai bước đã gỡ thành công', 'Xác thực 2 bước đã tắt', '{$greeting_user}<br /><br />Theo yêu cầu của bạn, chúng tôi đã tắt tính năng Xác thực 2 bước cho tài khoản của bạn tại website {$site_name}.<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Notice that two-step authentication has been successfully removed', '', ''),
(1049, 'en', 'users', 'users', 16, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Information about turning off 2-step verification', '{$greeting_user}<br /><br />We have received a request to turn off 2-step verification for your account at the {$site_name} website. If you sent this request yourself, please use the Verification Code below to proceed:<br /><br />Verification Code: <strong>{$code}</strong><br /><br />This is email automatic sending from website {$site_name}.', 'Hướng dẫn tắt xác thực hai bước khi quên mã', 'Thông tin tắt xác thực 2 bước', '{$greeting_user}<br /><br />Chúng tôi vừa nhận được yêu cầu tắt xác thực 2 bước cho tài khoản của bạn tại website {$site_name}. Nếu bạn là người gửi yêu cầu này, hãy sử dụng Mã xác minh dưới đây để tiến hành tắt:<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Instructions for turning off two-step authentication when forgetting code', '', ''),
(1050, 'en', 'users', 'users', 17, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that a third party account <strong>{$oauth_name}</strong> has just been connected to your <strong>{$username}</strong> account by the group leader.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo oauth được thêm vào tài khoản bởi trưởng nhóm', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được kết nối với tài khoản <strong>{$username}</strong> của bạn bởi trưởng nhóm.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notification oauth is added to the account by the team leader', '', ''),
(1051, 'en', 'users', 'users', 18, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />The third party account <strong>{$oauth_name}</strong> has just been connected to your <strong>{$username}</strong> account. If this was not your intention, please quickly remove it from your account by visiting the third party account management area.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo oauth được thêm vào tài khoản bởi chính người dùng', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được kết nối với tài khoản <strong>{$username}</strong> của bạn. Nếu đây không phải là chủ ý của bạn, vui lòng nhanh chóng xóa nó khỏi tài khoản của mình bằng cách truy cập vào khu vực quản lý tài khoản bên thứ ba.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notification oauth is added to the account by the user themselves', '', ''),
(1052, 'en', 'users', 'users', 19, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that the third party account <strong>{$oauth_name}</strong> has just been disconnected from your <strong>{$username}</strong> account by the group leader.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi trưởng nhóm', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản <strong>{$username}</strong> của bạn bởi trưởng nhóm.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notification oauth is removed to the account by the team leader', '', ''),
(1053, 'en', 'users', 'users', 21, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />The third-party account <strong>{$oauth_name}</strong> has just been disconnected from your <strong>{$username}</strong> account. If this is not your intention, please quickly contact the site administrator for help.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi chính người dùng', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản <strong>{$username}</strong> của bạn. Nếu đây không phải là chủ ý của bạn, vui lòng nhanh chóng liên hệ với quản trị site để được giúp đỡ.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notification oauth is removed to the account by the user themselves', '', ''),
(1054, 'en', 'users', 'users', 22, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'New e-mail verification', 'Hello!<br /><br />You have sent a request to verify your email address: {$email}. Copy the code below and paste it into the Verification code box on the site.<br /><br />Verification code: <strong>{$code}</strong><br /><br />This is email automatic sending from website {$site_name}.', 'Gửi mã xác minh email khi đăng nhập qua Oauth mà email trùng với tài khoản đã có', 'Thư xác minh email mới', 'Xin chào!<br /><br />Bạn đã gửi yêu cầu xác minh email: {$email}. Hãy chép mã dưới đây vào ô Mã xác minh trên site.<br /><br />Mã xác minh: <strong>{$code}</strong><br /><br />Đây là thư tự động được gửi đến email của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Send email verification code when logging in via Oauth and the email matches your existing account', '', ''),
(1055, 'en', 'users', 'users', 24, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Your account has been created', '{$greeting_user}<br /><br />Your account at website {$site_name} activated. {if empty($oauth_name)}Your login information:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Username: {$username}<br />{if not empty($password)}Password: {$password}{/if}{else}To log into your account please visit the page: <a href=\"{$link}\">{$link}</a> and press the button: <strong>Sign in with {$oauth_name}</strong>.{if not empty($password)}<br /><br />You can also log in using the usual method with the following information:<br />Username: {$username}<br />Password: {$password}{/if}{/if}{if $pass_reset eq 2}<br />Note: We recommend that you change your password before using your account.{elseif $pass_reset eq 1}<br />Note: You need to change your password before using your account.{/if}<br /><br />This is email automatic sending from website {$site_name}.', 'Email thông báo cho người dùng khi quản trị kích hoạt tài khoản', 'Tài khoản của bạn đã được tạo', '{$greeting_user}<br /><br />Tài khoản của bạn tại website {$site_name} đã được kích hoạt. {if empty($oauth_name)}Dưới đây là thông tin đăng nhập:<br /><br />URL: <a href=\"{$link}\">{$link}</a><br />Bí danh: {$username}<br />{if not empty($password)}Mật khẩu: {$password}{/if}{else}Để đăng nhập vui lòng truy cập vào trang: <a href=\"{$link}\">{$link}</a> và click vào nút: <strong>Đăng nhập bằng {$oauth_name}</strong>.{if not empty($password)}<br /><br />Bạn cũng có thể đăng nhập theo cách thông thường với thông tin:<br />Bí danh: {$username}<br />Mật khẩu: {$password}{/if}{/if}{if $pass_reset eq 2}<br />Chú ý: Chúng tôi khuyến cáo bạn nên thay đổi mật khẩu trước khi sử dụng tài khoản.{elseif $pass_reset eq 1}<br />Lưu ý: Bạn cần đổi mật khẩu trước khi sử dụng tài khoản.{/if}<br /><br />Đây là thư tự động được gửi đến hòm thư điện tử của bạn từ website {$site_name}. Nếu bạn không hiểu gì về nội dung bức thư này, đơn giản hãy xóa nó đi.', 'Email notifies users when the administrator activates the account', '', ''),
(1056, 'en', 'users', 'users', 25, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', '{if $pass_reset eq 2}Recommended account password change{else}Need to change account password{/if}', '{$greeting_user}<br /><br />The {$site_name} website administration informs: For security reasons, {if $pass_reset eq 2}we recommend that you{else}you need to{/if} change your account password as soon as possible. To change your password, you need to first visit the <a href=\"{$link}\">Manage Personal Account page</a>, select the Account Settings button, then the Password button, and follow the instructions.', 'Email yêu cầu người dùng thay đổi mật khẩu', '{if $pass_reset eq 2}Khuyến cáo thay đổi mật khẩu truy cập{else}Cần thay đổi mật khẩu truy cập{/if}', '{$greeting_user}<br /><br />Ban quản trị website {$site_name} xin thông báo: Vì lý do bảo mật chúng tôi {if $pass_reset eq 2}khuyến cáo bạn nên{else}đề nghị bạn nhanh chóng{/if} thay đổi mật khẩu truy cập tài khoản của mình. Để thay đổi mật khẩu, trước hết bạn cần truy cập vào trang <a href=\"{$link}\">Quản lý tài khoản cá nhân</a>, chọn nút Thiết lập tài khoản, sau đó chọn nút Mật khẩu và làm theo hướng dẫn.', 'Email asking user to change password', '', ''),
(1057, 'en', 'users', 'users', 26, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />Your account has just had two-step authentication disabled by your administrator. We send you this email to inform you.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Manage two-step authentication</a>', 'Thông báo đến người dùng xác thực hai bước đã được quản trị tắt', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn vừa được tắt xác thực hai bước bởi quản trị viên. Chúng tôi gửi cho bạn email này để thông tin đến bạn.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý xác thực hai bước</a>', 'Notification to users that two-step authentication has been turned off by the administrator', '', ''),
(1058, 'en', 'users', 'users', 20, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />We are informing you that the third party account <strong>{$oauth_name}</strong> has just been disconnected from your account by an administrator. We send you this email to inform you.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo oauth được xóa khỏi tài khoản bởi quản trị', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tài khoản bên thứ ba <strong>{$oauth_name}</strong> vừa được ngắt kết nối khỏi tài khoản của bạn bởi quản trị viên.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notify users when administrators delete their third-party account', '', ''),
(1059, 'en', 'users', 'users', 23, '3', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />We inform you that all third party accounts have been disconnected from your account by an administrator.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Third-party accounts Management</a>', 'Thông báo đến người dùng khi quản trị xóa tất cả Oauth của họ', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Chúng tôi thông tin đến bạn là tất cả các tài khoản bên thứ ba vừa được ngắt kết nối khỏi tài khoản của bạn bởi quản trị viên.<br /><br /><a href=\"{$link}\" style=\"font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#4184f3;border-radius:5px;min-width:90px\">Quản lý tài khoản bên thứ ba</a>', 'Notify users when administrators delete all of their third-party accounts', '', ''),
(1060, 'en', 'two-step-verification', 'two-step-verification', 1, '5', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just enabled Two-Factor Authentication. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, your account is most likely stolen. Please contact the site administrator for assistance', 'Thông báo bật xác thực hai bước cho tài khoản thành viên', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa kích hoạt chức năng xác thực hai bước qua ứng dụng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, rất có thể tài khoản của bạn đã bị đánh cắp. Hãy liên hệ với quản trị site để được hỗ trợ', 'Notice to enable two-step authentication for member accounts', '', ''),
(1061, 'en', 'two-step-verification', 'two-step-verification', 2, '5', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just disabled Two-Factor Authentication. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, please check your personal information at <a href=\"{$link}\">{$link}</a>', 'Thông báo tắt xác thực hai bước cho tài khoản thành viên', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa tắt chức năng xác thực hai bước qua ứng dụng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, mời kiểm tra lại thông tin cá nhân tại <a href=\"{$link}\">{$link}</a>', 'Notice to turn off two-step authentication for member accounts', '', ''),
(1062, 'en', 'two-step-verification', 'two-step-verification', 3, '5', '', 3, 1724661663, 0, '', '', '', '', '', 1, 0, 0, 0, '', 'Privacy Notice', '{$greeting_user}<br /><br />Your account at <a href=\"{$Home}\"><strong>{$site_name}</strong></a> has just recreated the backup code. Information:<br /><br />- Time: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Browser: <strong>{$browser}</strong><br /><br />If this is you, ignore this email. If this is not you, please check your personal information at <a href=\"{$link}\">{$link}</a>', 'Thông báo tạo lại mã dự phòng xác thực hai bước cho tài khoản thành viên', 'Thông báo bảo mật', '{$greeting_user}<br /><br />Tài khoản của bạn tại website <a href=\"{$Home}\"><strong>{$site_name}</strong></a> vừa tạo lại mã dự phòng. Thông tin:<br /><br />- Thời gian: <strong>{$time}</strong><br />- IP: <strong>{$ip}</strong><br />- Trình duyệt: <strong>{$browser}</strong><br /><br />Nếu đây đúng là bạn, hãy bỏ qua email này. Nếu đây không phải là bạn, mời kiểm tra lại thông tin cá nhân tại <a href=\"{$link}\">{$link}</a>', 'Notice of regenerating two-step authentication backup codes for member accounts', '', '');
...
INSERT INTO `nv4_emailtemplates_categories` (`catid`, `time_add`, `time_update`, `weight`, `is_system`, `status`, `vi_title`, `en_title`) VALUES
(1, 1724081655, 0, 1, 1, 1, 'Email của hệ thống', 'System Messages'),
(2, 1724081655, 0, 3, 1, 1, 'Email về quản trị', 'Admin Messages'),
(3, 1724081655, 0, 2, 1, 1, 'Email về tài khoản', 'User Messages'),
(4, 1724081655, 0, 4, 1, 1, 'Email của các module', 'Module Messages');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_en_about`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_about`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_about_config`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_about_config`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_blocks_groups`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_blocks_groups`
--

INSERT INTO `nv4_en_blocks_groups` (`bid`, `theme`, `module`, `file_name`, `title`, `link`, `template`, `position`, `dtime_type`, `dtime_details`, `active`, `act`, `groups_view`, `all_func`, `weight`, `config`) VALUES
...
(15, 'default', 'inform', 'global.inform.php', 'Notification', '', 'no_title', '[PERSONALAREA]', 'regular', '[]', '1', 1, '6', 1, 1, ''),
...
(24, 'mobile_default', 'inform', 'global.inform.php', 'Notification', '', 'no_title', '[MENU_SITE]', 'regular', '[]', '1', 1, '6', 1, 2, ''),
...
--
-- Cấu trúc bảng cho bảng `nv4_en_blocks_weight`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_blocks_weight`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_comment`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_contact_department`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_contact_reply`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_contact_send`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_contact_supporter`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_freecontent_blocks`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_freecontent_rows`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_menu`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_menu`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_menu_rows`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_menu_rows`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_modfuncs`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_modfuncs`
--

INSERT INTO `nv4_en_modfuncs` (`func_id`, `func_name`, `alias`, `func_custom_name`, `func_site_title`, `description`, `in_module`, `show_func`, `in_submenu`, `subweight`, `setting`) VALUES
...
--
-- Cấu trúc bảng cho bảng `nv4_en_modthemes`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_modthemes`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_modules`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_modules`
--

INSERT INTO `nv4_en_modules` (`title`, `module_file`, `module_data`, `module_upload`, `module_theme`, `custom_title`, `site_title`, `admin_title`, `set_time`, `main_file`, `admin_file`, `theme`, `mobile`, `description`, `keywords`, `icon`, `groups_view`, `weight`, `act`, `admins`, `rss`, `sitemap`) VALUES
('about', 'page', 'about', 'about', 'page', 'About', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-campground', '6', 1, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Banners', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-rectangle-ad', '6', 10, 1, '', 0, 1),
('comment', 'comment', 'comment', 'comment', 'comment', 'Comment', '', '', 1724661663, 0, 1, '', '', '', '', 'fa-solid fa-comments', '6', 15, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Contact', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-phone', '6', 7, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-rss', '6', 13, 1, '', 0, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Introduction', '', '', 1724661663, 0, 1, '', '', '', '', 'fa-solid fa-cube', '6', 17, 1, '', 0, 1),
('inform', 'inform', 'inform', 'inform', 'inform', 'Notification', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-bell', '4', 6, 1, '', 0, 0),
('menu', 'menu', 'menu', 'menu', 'menu', 'Navigation Bar', '', '', 1724661663, 0, 1, '', '', '', '', 'fa-solid fa-network-wired', '6', 12, 1, '', 0, 1),
('myapi', 'myapi', 'myapi', 'myapi', 'myapi', 'My APIs', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-brands fa-nfc-symbol', '6', 5, 1, '', 0, 0),
('news', 'news', 'news', 'news', 'news', 'News', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-newspaper', '6', 3, 1, '', 1, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-file-pen', '6', 14, 1, '', 1, 0),
('seek', 'seek', 'seek', 'seek', 'seek', 'Search', '', '', 1724661663, 1, 0, '', '', '', '', 'fa-solid fa-magnifying-glass', '6', 11, 1, '', 0, 1),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Terms & Conditions', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-gavel', '6', 16, 1, '', 1, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Statistics', '', '', 1724661663, 1, 1, '', '', '', 'online, statistics', 'fa-solid fa-chart-simple', '6', 8, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', '2-Step Verification', '', '', 1724661663, 1, 0, '', '', '', '', 'fa-solid fa-shield-halved', '6', 18, 1, '', 0, 1),
('users', 'users', 'users', 'users', 'users', 'Users', '', 'Users', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-users', '6', 4, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Voting', '', '', 1724661663, 1, 1, '', '', '', '', 'fa-solid fa-square-poll-vertical', '6', 9, 1, '', 1, 1),
('zalo', 'zalo', 'zalo', 'zalo', 'zalo', 'Zalo', '', 'Zalo', 1724661663, 0, 1, '', '', '', '', 'fa-solid fa-z', '3', 2, 1, '', 0, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nv4_en_news_1`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_1`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_2`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_3`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_4`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_4`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_5`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_6`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_7`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_7`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_8`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_8`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_9`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_10`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_11`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_12`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_12`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_13`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_14`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_14`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_admins`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_author`
--

DROP TABLE IF EXISTS `nv4_en_news_author`;
CREATE TABLE `nv4_en_news_author` (
  `id` mediumint(8) UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_authorlist`
--

DROP TABLE IF EXISTS `nv4_en_news_authorlist`;
CREATE TABLE `nv4_en_news_authorlist` (
  `id` int(11) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_block`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_block_cat`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_block_cat`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_cat`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_cat`
--

INSERT INTO `nv4_en_news_cat` (`catid`, `parentid`, `title`, `titlesite`, `alias`, `description`, `descriptionhtml`, `image`, `viewdescription`, `weight`, `sort`, `lev`, `viewcat`, `numsubcat`, `subcatid`, `numlinks`, `newday`, `featured`, `ad_block_cat`, `layout_func`, `keywords`, `admins`, `add_time`, `edit_time`, `groups_view`, `status`) VALUES
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_config_post`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_detail`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_detail`
--

INSERT INTO `nv4_en_news_detail` (`id`, `titlesite`, `description`, `bodyhtml`, `voicedata`, `keywords`, `sourcetext`, `files`, `imgposition`, `layout_func`, `copyright`, `allowed_send`, `allowed_print`, `allowed_save`, `auto_nav`, `group_view`, `localization`) VALUES
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_logs`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_report`
--

DROP TABLE IF EXISTS `nv4_en_news_report`;
CREATE TABLE `nv4_en_news_report` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_rows`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_rows`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_row_histories`
--

DROP TABLE IF EXISTS `nv4_en_news_row_histories`;
CREATE TABLE `nv4_en_news_row_histories` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_sources`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_sources`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_tags`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_tags`
--

INSERT INTO `nv4_en_news_tags` (`tid`, `numnews`, `title`, `alias`, `image`, `description`, `keywords`) VALUES
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_tags_id`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_news_tags_id`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_tmp`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_topics`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_news_voices`
--

DROP TABLE IF EXISTS `nv4_en_news_voices`;
CREATE TABLE `nv4_en_news_voices` (
...
--
-- Cấu trúc bảng cho bảng `nv4_en_page`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_page_config`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_page_config`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_referer_stats`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_searchkeys`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_siteterms`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_siteterms_config`
--
...
--
-- Đang đổ dữ liệu cho bảng `nv4_en_siteterms_config`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_voting`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_voting_rows`
--
...
--
-- Cấu trúc bảng cho bảng `nv4_en_voting_voted`
--

DROP TABLE IF EXISTS `nv4_en_voting_voted`;
CREATE TABLE `nv4_en_voting_voted` (
  `vid` smallint(5) UNSIGNED NOT NULL,
...
(1, 1, '127.0.0.1', 0, 1, 1724083820, 0, '');
...
(1, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724083905),
(2, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724084012),
(3, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724084022),
(4, 'vi', 'users', 'log_add_user', 'userid 2', '', 1, 1724084072),
(5, 'vi', 'laudatory', 'Add ', ' ', '', 1, 1724084096),
(6, 'vi', 'laudatory', 'Add POSITION', ' ', '', 1, 1724084136),
(7, 'vi', 'laudatory', 'Add', 'ID: 2', '', 1, 1724084153),
(8, 'vi', 'upload', 'Upload file', 'uploads/laudatory/cristiano_ronaldo_playing_for_al_nassr_fc_against_persepolis_september_2023_cropped.jpg.webp', '', 1, 1724084204),
(9, 'vi', 'menu', 'Add row menu', 'Row menu id: 23 of Menu id: 1', '', 1, 1724084227),
(10, 'vi', 'laudatory', 'Add ', ' ', '', 1, 1724084272),
(11, 'vi', 'laudatory', 'Add', 'ID: 2', '', 1, 1724084289),
(12, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724086106),
(13, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724086240),
(14, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724088639),
(15, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724089161),
(16, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724142133),
(17, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724143937),
(18, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724165277),
(19, 'vi', 'modules', 'Thiết lập module mới quote', '', '', 1, 1724165315),
(20, 'vi', 'modules', 'Sửa module &ldquo;quote&rdquo;', '', '', 1, 1724165376),
(21, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724165631),
(22, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724166167),
(23, 'vi', 'quote', 'log_add_author', 'id 31', '', 1, 1724166196),
(24, 'vi', 'quote', 'log_edit_author', 'id 31', '', 1, 1724171357),
(25, 'vi', 'news', 'add_tags', 'dá', '', 1, 1724171400),
(26, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724245844),
(27, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724247659),
(28, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724253906),
(29, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724296359),
(30, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724296389),
(31, 'vi', 'extensions', 'Cài đặt ứng dụng', 'laudatory_2024-main.zip', '', 1, 1724296426),
(32, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724296489),
(33, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724296694),
(34, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724296707),
(35, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724296819),
(36, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724296860),
(37, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724296898),
(38, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724296962),
(39, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724296972),
(40, 'vi', 'extensions', 'Cài đặt ứng dụng', 'module-laws-nukeviet4.6 (1).zip', '', 1, 1724297534),
(41, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724297635),
(42, 'vi', 'extensions', 'Cài đặt ứng dụng', 'laudatory_2024-main.zip', '', 1, 1724297711),
(43, 'vi', 'extensions', 'Cài đặt ứng dụng', 'module-laws-nukeviet4.6.zip', '', 1, 1724297792),
(44, 'vi', 'extensions', 'Cài đặt ứng dụng', 'laudatory_2024-main.zip', '', 1, 1724298193),
(45, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724298207),
(46, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724298233),
(47, 'vi', 'extensions', 'Cài đặt ứng dụng', 'laudatory_2024-main.zip', '', 1, 1724298260),
(48, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724298271),
(49, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724298280),
(50, 'vi', 'laudatory', 'Add ', ' ', '', 1, 1724299465),
(51, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724301279),
(52, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724383941),
(53, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724383949),
(54, 'vi', 'extensions', 'Cài đặt ứng dụng', 'laudatory_2024.zip', '', 1, 1724383967),
(55, 'vi', 'modules', 'Thiết lập module mới laudatory', '', '', 1, 1724383992),
(56, 'vi', 'modules', 'Sửa module &ldquo;laudatory&rdquo;', '', '', 1, 1724384005),
(57, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724385826),
(58, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724426049),
(59, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724593149),
(60, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724596883),
(61, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724596943),
(62, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724597904),
(63, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724597990),
(64, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724598142),
(65, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724631425),
(66, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724631520),
(67, 'vi', 'users', 'log_edit_user', 'userid 2', '', 1, 1724634200),
(68, 'vi', 'modules', 'Xóa module \"laudatory\"', '', '', 1, 1724638531),
(69, 'vi', 'modules', 'Xóa module \"quote\"', '', '', 1, 1724638577),
(70, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1724638732),
(71, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1724638734),
(72, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1724638734),
(73, 'vi', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1724638734),
(74, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724638750),
(75, 'vi', 'users', 'log_add_user', 'userid 3', '', 1, 1724639514),
(76, 'vi', 'users', 'log_del_user', 'userid 3', '', 1, 1724639566),
(77, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 0, 1724647467),
(78, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724660945),
(79, 'vi', 'users', 'log_add_user', 'userid 4', '', 1, 1724661202),
(80, 'vi', 'users', 'log_edit_user', 'userid 4', '', 1, 1724661209),
(81, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724661658),
(82, 'vi', 'language', 'Cài đặt mới Ngôn ngữ data', ' langkey : en', '', 1, 1724661663),
(83, 'en', 'language', 'Hiển thị ngoài site', ' langkey : en [ Có ]', '', 1, 1724661726),
(84, 'en', 'webtools', 'System cleanup', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724662763),
(85, 'en', 'webtools', 'System cleanup', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724662911),
(86, 'en', 'webtools', 'System cleanup', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724662997),
(87, 'en', 'webtools', 'System cleanup', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1724663052),
(88, 'vi', 'users', 'log_del_user', 'userid 2', '', 1, 1724663285),
(89, 'vi', 'users', 'log_edit_user', 'userid 1', '', 1, 1724663308),
(90, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 1, 1724663328),
(91, 'en', 'login', '[admin] Đăng nhập Thất bại', ' Client IP:127.0.0.1', '', 0, 1724663339),
(92, 'en', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724663345),
(93, 'en', 'users', 'log_add_user', 'userid 5', '', 1, 1724663413),
(94, 'vi', 'users', 'log_edit_user', 'userid 5', '', 1, 1724663463),
(95, 'vi', 'users', 'log_add_user', 'userid 6', '', 1, 1724663500),
(96, 'vi', 'users', 'log_add_user', 'userid 7', '', 1, 1724663839),
(97, 'vi', 'login', '[admin] Thoát khỏi tài khoản quản trị', ' Client IP:127.0.0.1', '', 1, 1724663848),
(98, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1724663961),
(99, 'vi', 'users', 'Kích hoạt tài khoản', 'userid: 8 - username: Hòa Nguyễn', '', 1, 1724663980),
...
(0, 'module', 'about', 0, 0, 'page', 'about', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(22, 'module', 'inform', 1, 0, 'inform', 'inform', '4.6.00 1666092814', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(22, 'module', 'myapi', 1, 0, 'myapi', 'myapi', '4.6.00 1666092814', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'zalo', 1, 0, 'zalo', 'zalo', '4.6.00 1637048941', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.5.00 1626512400', 1724081655, 'VINADES <contact@vinades.vn>', '');
...
(0, '', 0, 0, 3, 100, 150, 90),
(1, 'uploads', 1724083800, 1413366, 0, 0, 0, 0),
(2, 'uploads/about', 1724083800, 242102, 0, 0, 0, 0),
(3, 'uploads/banners', 1724083800, 179287, 0, 0, 0, 0),
(4, 'uploads/banners/files', 1724083800, 0, 0, 0, 0, 0),
(5, 'uploads/comment', 1724083800, 0, 0, 0, 0, 0),
(6, 'uploads/contact', 1724083800, 0, 0, 0, 0, 0),
(7, 'uploads/emailtemplates', 1724083800, 0, 0, 0, 0, 0),
(8, 'uploads/feeds', 1724083800, 0, 0, 0, 0, 0),
(9, 'uploads/freecontent', 1724083800, 138096, 0, 0, 0, 0),
(10, 'uploads/inform', 1724083800, 0, 0, 0, 0, 0),
(12, 'uploads/menu', 1724083800, 0, 0, 0, 0, 0),
(13, 'uploads/news', 1724083800, 853881, 0, 0, 0, 0),
(14, 'uploads/news/authors', 1724083800, 0, 0, 0, 0, 0),
(15, 'uploads/news/source', 1724083800, 0, 0, 0, 0, 0),
(16, 'uploads/news/temp_pic', 1724083800, 0, 0, 0, 0, 0),
(17, 'uploads/news/topics', 1724083800, 0, 0, 0, 0, 0),
(18, 'uploads/page', 1724083800, 0, 0, 0, 0, 0),
(19, 'uploads/push-notification', 1724083800, 0, 0, 0, 0, 0),
(20, 'uploads/siteterms', 1724083800, 0, 0, 0, 0, 0),
(21, 'uploads/users', 1724083800, 0, 0, 0, 0, 0),
(22, 'uploads/users/groups', 1724083800, 0, 0, 0, 0, 0),
(23, 'uploads/users/userfiles', 1724083800, 0, 0, 0, 0, 0),
(24, 'uploads/zalo', 1724083800, 0, 0, 0, 0, 0),
(26, 'uploads/news/2024_08', 0, 0, 0, 0, 0, 0);
...
('logo-nukev...png', 'png', 'image', 13223, 'assets/about/logo-nukeviet3-flag-180x75.png', 80, 34, '180|75', 1, 1723912314, 2, 'logo-nukeviet3-flag-180x75.png', 'logo nukeviet3 flag 180x75'),
('nukevietcm...png', 'png', 'image', 13125, 'assets/about/nukevietcms_laco_180x57.png', 80, 26, '180|57', 1, 1723912314, 2, 'nukevietcms_laco_180x57.png', 'nukevietcms laco 180x57'),
('nukevietcm...png', 'png', 'image', 13319, 'assets/about/nukevietcms_mu_noel_180x84.png', 80, 38, '180|84', 1, 1723912314, 2, 'nukevietcms_mu_noel_180x84.png', 'nukevietcms mu noel 180x84'),
('nukevietcm...png', 'png', 'image', 11974, 'assets/about/nukevietcms-180x84.png', 80, 38, '180|84', 1, 1723912314, 2, 'nukevietcms-180x84.png', 'nukevietcms 180x84'),
('nukevietcms.png', 'png', 'image', 85684, 'assets/about/nukevietcms.png', 80, 38, '1500|700', 1, 1723912314, 2, 'nukevietcms.png', 'nukevietcms'),
('nukevietvn...png', 'png', 'image', 11586, 'assets/about/nukevietvn_180x84.png', 80, 38, '180|84', 1, 1723912314, 2, 'nukevietvn_180x84.png', 'nukevietvn 180x84'),
('nukevietvn.png', 'png', 'image', 81035, 'assets/about/nukevietvn.png', 80, 38, '1500|700', 1, 1723912314, 2, 'nukevietvn.png', 'nukevietvn'),
('w.png', 'png', 'image', 12156, 'assets/about/w.png', 80, 40, '288|143', 1, 1723912314, 2, 'w.png', 'w'),
('vinades.jpg', 'jpg', 'image', 104940, 'assets/banners/vinades.jpg', 43, 80, '212|400', 1, 1723912314, 3, 'vinades.jpg', 'vinades'),
('webnhanh.jpg', 'jpg', 'image', 74347, 'assets/banners/webnhanh.jpg', 80, 10, '572|72', 1, 1723912314, 3, 'webnhanh.jpg', 'webnhanh'),
('cms.jpg', 'jpg', 'image', 29026, 'assets/freecontent/cms.jpg', 80, 44, '130|71', 1, 1723912314, 9, 'cms.jpg', 'cms'),
('edugate.jpg', 'jpg', 'image', 28008, 'assets/freecontent/edugate.jpg', 80, 44, '130|71', 1, 1723912314, 9, 'edugate.jpg', 'edugate'),
('portal.jpg', 'jpg', 'image', 25973, 'assets/freecontent/portal.jpg', 80, 44, '130|71', 1, 1723912314, 9, 'portal.jpg', 'portal'),
('shop.jpg', 'jpg', 'image', 26352, 'assets/freecontent/shop.jpg', 80, 44, '130|71', 1, 1723912314, 9, 'shop.jpg', 'shop'),
('toa-soan-d...jpg', 'jpg', 'image', 28737, 'assets/freecontent/toa-soan-dien-tu.jpg', 80, 44, '130|71', 1, 1723912314, 9, 'toa-soan-dien-tu.jpg', 'toa soan dien tu'),
('chuc-mung-...jpg', 'jpg', 'image', 130708, 'assets/news/chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 80, 62, '461|360', 1, 1723912314, 13, 'chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 'chuc mung nukeviet thong tu 20 bo tttt'),
('hoc-viec-t...jpg', 'jpg', 'image', 167193, 'assets/news/hoc-viec-tai-cong-ty-vinades.jpg', 80, 63, '460|360', 1, 1723912314, 13, 'hoc-viec-tai-cong-ty-vinades.jpg', 'hoc viec tai cong ty vinades'),
('hoptac.jpg', 'jpg', 'image', 12871, 'assets/news/hoptac.jpg', 80, 66, '382|314', 1, 1723912314, 13, 'hoptac.jpg', 'hoptac'),
('nangly.jpg', 'jpg', 'image', 34802, 'assets/news/nangly.jpg', 80, 53, '500|332', 1, 1723912314, 13, 'nangly.jpg', 'nangly'),
('nukeviet-cms.jpg', 'jpg', 'image', 83489, 'assets/news/nukeviet-cms.jpg', 80, 55, '500|345', 1, 1723912314, 13, 'nukeviet-cms.jpg', 'nukeviet cms'),
('nukeviet-n...jpg', 'jpg', 'image', 18611, 'assets/news/nukeviet-nhantaidatviet2011.jpg', 80, 54, '400|268', 1, 1723912314, 13, 'nukeviet-nhantaidatviet2011.jpg', 'nukeviet nhantaidatviet2011'),
('tap-huan-p...jpg', 'jpg', 'image', 132379, 'assets/news/tap-huan-pgd-ha-dong-2015.jpg', 80, 52, '460|295', 1, 1723912314, 13, 'tap-huan-pgd-ha-dong-2015.jpg', 'tap huan pgd ha dong 2015'),
('thuc-tap-sinh.jpg', 'jpg', 'image', 71135, 'assets/news/thuc-tap-sinh.jpg', 80, 63, '460|360', 1, 1723912314, 13, 'thuc-tap-sinh.jpg', 'thuc tap sinh'),
('tuyen-dung...png', 'png', 'image', 118910, 'assets/news/tuyen-dung-nvkd.png', 80, 56, '400|279', 1, 1723912314, 13, 'tuyen-dung-nvkd.png', 'tuyen dung nvkd'),
('tuyendung-...jpg', 'jpg', 'image', 83783, 'assets/news/tuyendung-kythuat.jpg', 80, 80, '300|300', 1, 1723912314, 13, 'tuyendung-kythuat.jpg', 'tuyendung kythuat');
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}z60cfr4cpm00oEa8T/5A47JGteUB+PTDiqNo86ZTI0aGEi/XmHjYmQOW4GndOU31n3t6/j+Z6+xKfcfBa62vz2UzMTU=', 'web@gmail.com', 'admin', '', 'M', '', -1179990000, '', 1724083800, '321', '321', '', 0, 1, '1,4', 1, 0, '', '', 1724083800, '', '', '', 1724663308, 0, 0, '', 1724663308, 0, -3, 'SYSTEM', ''),
(5, 4, 'Huy Nguyễn', '90edf5b69566a99d520872b9ed3d7299', '{SSHA512}XuVWmmrsWdCHD1o7MLOozWj5/v3DbkbLkjgMUoIYjxcTMLg0PlnTkrOC9bW7oBlt6Fyc/ZYXHWCa8V6J7wmZsGU0MmQ=', 'haiha0095343@gmail.com', 'Huy', 'Nguyễn', 'M', '', -1179471600, '', 1724663413, '123', '313', '', 0, 1, '4', 1, 0, '', '', 0, '', '', '', 1724663463, 0, 0, '', 1724663413, 0, -1, 'SYSTEM', ''),
(4, 4, 'Hải nguyễn', 'f6eadb3f9f3d16f4e84cd7b8439c0e92', '{SSHA512}WOh5/Dq7TdYxoYz/NVhvD2OfrxEmPfv/4RZSDcsyBHPS0HPATA4ZHZEPbhCSehq2pHlnidjzwg3hkon2ElGUnTA1ODM=', 'haiha0095@gmail.com', 'hải', 'Nguyễn', 'M', '', -1274943600, '', 1724661202, '1234', '3133', '', 0, 1, '4', 1, 0, '', '', 0, '', '', '', 1724661209, 0, 0, '', 1724661202, 1, -1, 'SYSTEM', ''),
(6, 4, 'Hùng Nguyễn', '58da69f3a179e58fe517bdcfa6032e0c', '{SSHA512}z8D9vmcRB/egi5qc3VnGGbUFh4/NWNKwQ8QrDknk9dJ4jdH0wN92lpy8e1lViHVFfyWxciuYm+ovgdZP9sJFlGU4NmM=', 'haiha0095rewrew@gmail.com', 'Hùng', 'Nguyễn', 'M', '', -1242889200, '', 1724663500, '1232', '323', '', 0, 1, '4', 1, 0, '', '', 0, '', '', '', 0, 0, 0, '', 1724663500, 1, -1, 'SYSTEM', ''),
(7, 4, 'Hiếu Nguyễn', '2d6b7acd35371236e41d9a34bd01567b', '{SSHA512}l+mev0BhABPM+xtG0Fm1HfTAF8Ahmej5pRiV44/1YyPrQmuB72PW6NQkLJ+42dI3MTHTFo5VCBq/xh1aX304nmExMWM=', 'haiha0095668@gmail.com', 'Hiếu', 'Nguyễn', 'M', '', -1275030000, '', 1724663839, '32313', '12323', '', 0, 1, '4', 1, 0, '', '', 0, '', '', '', 1724683453, 0, 0, '', 1724663839, 0, -1, 'SYSTEM', ''),
(8, 4, 'Hòa Nguyễn', '53174475959abc2bb9a2d465af357afe', '{SSHA512}6Ezx5mxmupsqXQRwAtvHuOAvKF4r2YroN9+yOsCqwZkNNk5B7kwk+XuKupwKpkwR6kefCDawLUD5YzEFF+uMhzc2ODU=', 'haiha009542424@gmail.com', 'Nguyễn', 'Hòa', 'M', '', -927961200, '', 1724663941, '123', '133', '', 0, 1, '4', 1, 0, '', '', 0, '', '', '', 1724683436, 0, 0, '', 1724663941, 0, -1, '1', '');
...
CREATE TABLE `nv4_users_field` (
  ...
  `field_type` enum('number','date','textbox','textarea','editor','select','radio','checkbox','multiselect','file','matrix') NOT NULL DEFAULT 'textbox',
  `field_choices` text NOT NULL,
  `sql_choices` text NOT NULL,
  `match_type` enum('none','alphanumeric','unicodename','email','url','regex','callback','matrix') NOT NULL DEFAULT 'none',
...
(2, 'last_name', 2, 'textbox', '', '', 'none', '', '', 0, 100, '', 0, 0, 1, 1, 1, 'input', 'a:2:{s:2:\"vi\";a:2:{i:0;s:4:\"Họ\";i:1;s:0:\"\";}s:2:\"en\";a:2:{i:0;s:9:\"Last Name\";i:1;s:0:\"\";}}', '', 1),
...
(7, 'answer', 7, 'textbox', '', '', 'none', '', '', 3, 255, '', 0, 1, 1, 1, 1, 'input', 'a:2:{s:2:\"vi\";a:2:{i:0;s:16:\"Câu trả lời\";i:1;s:0:\"\";}s:2:\"en\";a:2:{i:0;s:6:\"Answer\";i:1;s:0:\"\";}}', '', 1),
(55, 'info', 8, 'matrix', '', '', 'none', '', '', 0, 0, '{\"rows\":3,\"cols\":3,\"row_titles\":[\"Tên Công Ty\",\"Mã Số Thuế(MST)\",\"Họ và tên người đại diện\",\"Địa Chỉ\",\"Năm thành lập\"],\"col_titles\":[\"Thông tin cần nhập\"]}', 0, 0, 1, 1, 1, 'input', 'a:1:{s:2:\"vi\";a:2:{i:0;s:19:\"Thông tin công ty\";i:1;s:0:\"\";}}', '', 0);
...
(1, 'Super-Admin', '', 0, '', '', 0, 0, 0, 1724081655, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(2, 'General-Admin', '', 0, '', '', 0, 0, 0, 1724081655, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(3, 'Module-Admin', '', 0, '', '', 0, 0, 0, 1724081655, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(4, 'Users', '', 0, '', '', 0, 0, 0, 1724081655, 0, 4, 1, 0, 6, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(7, 'New-Users', '', 0, '', '', 0, 0, 0, 1724081655, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(5, 'Guest', '', 0, '', '', 0, 0, 0, 1724081655, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(6, 'All', '', 0, '', '', 0, 0, 0, 1724081655, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(10, 'NukeViet-Fans', '', 2, '', '', 0, 0, 1, 1724081655, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(11, 'NukeViet-Admins', '', 2, '', '', 0, 0, 0, 1724081655, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(12, 'NukeViet-Programmers', '', 1, '', '', 0, 0, 0, 1724081655, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}');
...
(1, 1, 1, 1, '0', 1724083800, 1724083800);
...
CREATE TABLE `nv4_users_info` (
  ...
  `info` text NOT NULL COMMENT 'Thông tin công ty'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `nv4_users_info` (`userid`, `inform`, `info`) VALUES
(1, '0|1724661541', ''),
(4, '', ''),
(5, '', ''),
(6, '', ''),
(7, '', '[[\"Công ty cổ phần phát triển nguồn mở Việt Nam (VINADES.,JSC hay công ty VINADES)\"],[\"0110063972\"],[\"Nguyễn Thế Hùng\"],[\"Tòa nhà Sông Đà, 131 Đường Trần Phú, P. Văn Quán, Hà Đông, Hà Nội 100000\"],[\"2010\"]]'),
(8, '', '[[\"Công ty cổ phần phát triển nguồn mở Việt Nam (VINADES.,JSC hay công ty VINADES)\"],[\"0110063972\"],[\"Nguyễn Thế Hùng\"],[\"Tòa nhà Sông Đà, 131 Đường Trần Phú, P. Văn Quán, Hà Đông, Hà Nội 100000\"],[\"2010\"]]');
...
--
-- Đang đổ dữ liệu cho bảng `nv4_users_oldpass`
--

INSERT INTO `nv4_users_oldpass` (`userid`, `password`, `pass_creation_time`) VALUES
(1, '{SSHA512}JIxl2uEkcqYLQcRsjr2nSbQFEoSgi8gbLxOzpuOjhz/l9lkkbHK7xh2VsRrfeTKFhydFBdRBK6T5+16LDLeskDU5ZGU=', 1724083800);
...
(23, 0, 1, 'Quản lý khen thưởng', '/index.php?language=vi&nv=laudatory', '', '', '', 8, 23, 0, '24,25,26', '6', 'laudatory', '', 1, '', 0, 1),
(24, 23, 1, 'Main', '/index.php?language=vi&nv=laudatory&amp;op=main', '', '', '', 1, 1, 1, '', '6', 'laudatory', 'main', 1, '', 1, 1),
(25, 23, 1, 'List-lau-year', '/index.php?language=vi&nv=laudatory&amp;op=list-lau-year', '', '', '', 2, 2, 1, '', '6', 'laudatory', 'list-lau-year', 1, '', 1, 1),
(26, 23, 1, 'Department_category', '/index.php?language=vi&nv=laudatory&amp;op=department_category', '', '', '', 3, 3, 1, '', '6', 'laudatory', 'department_category', 1, '', 1, 1);
...
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-campground', '6', 1, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-rectangle-ad', '6', 10, 1, '', 0, 1),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1724081655, 0, 1, '', '', '', '', 'fa-solid fa-comments', '6', 15, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-phone', '6', 7, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-rss', '6', 13, 1, '', 0, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1724081655, 0, 1, '', '', '', '', 'fa-solid fa-cube', '6', 17, 1, '', 0, 1),
('inform', 'inform', 'inform', 'inform', 'inform', 'Thông báo', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-bell', '4', 6, 1, '', 0, 0),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1724081655, 0, 1, '', '', '', '', 'fa-solid fa-network-wired', '6', 12, 1, '', 0, 1),
('myapi', 'myapi', 'myapi', 'myapi', 'myapi', 'API của tôi', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-brands fa-nfc-symbol', '6', 5, 1, '', 0, 0),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-newspaper', '6', 3, 1, '', 1, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-file-pen', '6', 14, 1, '', 1, 0),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1724081655, 1, 0, '', '', '', '', 'fa-solid fa-magnifying-glass', '6', 11, 1, '', 0, 1),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-gavel', '6', 16, 1, '', 1, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1724081655, 1, 1, '', '', '', 'online, statistics', 'fa-solid fa-chart-simple', '6', 8, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1724081655, 1, 0, '', '', '', '', 'fa-solid fa-shield-halved', '6', 18, 1, '', 0, 1),
('users', 'users', 'users', 'users', 'users', 'Tài khoản người dùng', '', 'Tài khoản', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-users', '6', 4, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1724081655, 1, 1, '', '', '', '', 'fa-solid fa-square-poll-vertical', '6', 9, 1, '', 1, 1),
('zalo', 'zalo', 'zalo', 'zalo', 'zalo', 'Zalo', '', 'Zalo', 1724081655, 0, 1, '', '', '', '', 'fa-solid fa-z', '3', 2, 1, '', 0, 0);
...
(1, 1, 'admin', 'admin', '', '', 1724171519, 0, 1, 0);
...
(2, 'Bạn biết gì về NukeViet 4?', '', 1, 0, 1, '6', 1724081655, 0, 1, 0),
(3, 'Lợi ích của phần mềm nguồn mở là gì?', '', 1, 0, 1, '6', 1724081655, 0, 1, 0);
...
--
-- Chỉ mục cho bảng `nv4_en_about_config`
--
ALTER TABLE `nv4_en_about_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `nv4_en_blocks_groups`
--
...
--
-- Chỉ mục cho bảng `nv4_en_blocks_weight`
--
ALTER TABLE `nv4_en_blocks_weight`
  ADD UNIQUE KEY `bid` (`bid`,`func_id`);

--
-- Chỉ mục cho bảng `nv4_en_comment`
--
...
--
-- Chỉ mục cho bảng `nv4_en_contact_department`
--
...
--
-- Chỉ mục cho bảng `nv4_en_contact_reply`
--
...
--
-- Chỉ mục cho bảng `nv4_en_contact_send`
--
...
--
-- Chỉ mục cho bảng `nv4_en_contact_supporter`
--
ALTER TABLE `nv4_en_contact_supporter`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nv4_en_freecontent_blocks`
--
ALTER TABLE `nv4_en_freecontent_blocks`
  ADD PRIMARY KEY (`bid`);

--
-- Chỉ mục cho bảng `nv4_en_freecontent_rows`
--
ALTER TABLE `nv4_en_freecontent_rows`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nv4_en_menu`
--
...
--
-- Chỉ mục cho bảng `nv4_en_menu_rows`
--
...
--
-- Chỉ mục cho bảng `nv4_en_modfuncs`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_2`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_3`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_4`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_5`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_6`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_7`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_8`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_9`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_10`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_11`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_12`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_13`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_14`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_admins`
--
ALTER TABLE `nv4_en_news_admins`
  ADD UNIQUE KEY `userid` (`userid`,`catid`);

--
-- Chỉ mục cho bảng `nv4_en_news_author`
--
ALTER TABLE `nv4_en_news_author`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uid` (`uid`),
  ADD UNIQUE KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `nv4_en_news_authorlist`
--
ALTER TABLE `nv4_en_news_authorlist`
  ADD UNIQUE KEY `id_aid` (`id`,`aid`),
  ADD KEY `aid` (`aid`),
  ADD KEY `alias` (`alias`);

--
-- Chỉ mục cho bảng `nv4_en_news_block`
--
ALTER TABLE `nv4_en_news_block`
  ADD UNIQUE KEY `bid` (`bid`,`id`);

--
-- Chỉ mục cho bảng `nv4_en_news_block_cat`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_cat`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_config_post`
--
ALTER TABLE `nv4_en_news_config_post`
  ADD PRIMARY KEY (`group_id`);

--
-- Chỉ mục cho bảng `nv4_en_news_detail`
--
ALTER TABLE `nv4_en_news_detail`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nv4_en_news_logs`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_report`
--
ALTER TABLE `nv4_en_news_report`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `newsid_md5content_post_ip` (`newsid`,`md5content`,`post_ip`);

--
-- Chỉ mục cho bảng `nv4_en_news_rows`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_row_histories`
--
ALTER TABLE `nv4_en_news_row_histories`
  ADD PRIMARY KEY (`id`),
...
--
-- Chỉ mục cho bảng `nv4_en_news_sources`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_tags`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_tags_id`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_tmp`
--
ALTER TABLE `nv4_en_news_tmp`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nv4_en_news_topics`
--
...
--
-- Chỉ mục cho bảng `nv4_en_news_voices`
--
ALTER TABLE `nv4_en_news_voices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`),
  ADD KEY `weight` (`weight`),
  ADD KEY `status` (`status`);
...
--
-- Chỉ mục cho bảng `nv4_en_page_config`
--
ALTER TABLE `nv4_en_page_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `nv4_en_referer_stats`
--
...
--
-- Chỉ mục cho bảng `nv4_en_searchkeys`
--
...
--
-- Chỉ mục cho bảng `nv4_en_siteterms`
--
...
--
-- Chỉ mục cho bảng `nv4_en_siteterms_config`
--
ALTER TABLE `nv4_en_siteterms_config`
  ADD UNIQUE KEY `config_name` (`config_name`);

--
-- Chỉ mục cho bảng `nv4_en_voting`
--
...
--
-- Chỉ mục cho bảng `nv4_en_voting_rows`
--
...
--
-- Chỉ mục cho bảng `nv4_en_voting_voted`
--
ALTER TABLE `nv4_en_voting_voted`
...
--
ALTER TABLE `nv4_emailtemplates`
  MODIFY `emailid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1063;
...
--
-- AUTO_INCREMENT cho bảng `nv4_en_about`
--
ALTER TABLE `nv4_en_about`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nv4_en_blocks_groups`
--
ALTER TABLE `nv4_en_blocks_groups`
  MODIFY `bid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `nv4_en_comment`
--
ALTER TABLE `nv4_en_comment`
  MODIFY `cid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_contact_department`
--
ALTER TABLE `nv4_en_contact_department`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_contact_reply`
--
ALTER TABLE `nv4_en_contact_reply`
  MODIFY `rid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_contact_send`
--
ALTER TABLE `nv4_en_contact_send`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_contact_supporter`
--
ALTER TABLE `nv4_en_contact_supporter`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_freecontent_blocks`
--
ALTER TABLE `nv4_en_freecontent_blocks`
  MODIFY `bid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_freecontent_rows`
--
ALTER TABLE `nv4_en_freecontent_rows`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_menu`
--
ALTER TABLE `nv4_en_menu`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `nv4_en_menu_rows`
--
ALTER TABLE `nv4_en_menu_rows`
  MODIFY `id` mediumint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `nv4_en_modfuncs`
--
ALTER TABLE `nv4_en_modfuncs`
  MODIFY `func_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_1`
--
ALTER TABLE `nv4_en_news_1`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_2`
--
ALTER TABLE `nv4_en_news_2`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_3`
--
ALTER TABLE `nv4_en_news_3`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_4`
--
ALTER TABLE `nv4_en_news_4`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_5`
--
ALTER TABLE `nv4_en_news_5`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_6`
--
ALTER TABLE `nv4_en_news_6`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_7`
--
ALTER TABLE `nv4_en_news_7`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_8`
--
ALTER TABLE `nv4_en_news_8`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_9`
--
ALTER TABLE `nv4_en_news_9`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_10`
--
ALTER TABLE `nv4_en_news_10`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_11`
--
ALTER TABLE `nv4_en_news_11`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_12`
--
ALTER TABLE `nv4_en_news_12`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_13`
--
ALTER TABLE `nv4_en_news_13`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_14`
--
ALTER TABLE `nv4_en_news_14`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_author`
--
ALTER TABLE `nv4_en_news_author`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_block_cat`
--
ALTER TABLE `nv4_en_news_block_cat`
  MODIFY `bid` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_cat`
--
ALTER TABLE `nv4_en_news_cat`
  MODIFY `catid` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_logs`
--
ALTER TABLE `nv4_en_news_logs`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_report`
--
ALTER TABLE `nv4_en_news_report`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_rows`
--
ALTER TABLE `nv4_en_news_rows`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_row_histories`
--
ALTER TABLE `nv4_en_news_row_histories`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_sources`
--
ALTER TABLE `nv4_en_news_sources`
  MODIFY `sourceid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_tags`
--
ALTER TABLE `nv4_en_news_tags`
  MODIFY `tid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_topics`
--
ALTER TABLE `nv4_en_news_topics`
  MODIFY `topicid` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_news_voices`
--
ALTER TABLE `nv4_en_news_voices`
  MODIFY `id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_page`
--
ALTER TABLE `nv4_en_page`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_siteterms`
--
ALTER TABLE `nv4_en_siteterms`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_voting`
--
ALTER TABLE `nv4_en_voting`
  MODIFY `vid` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nv4_en_voting_rows`
--
ALTER TABLE `nv4_en_voting_rows`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `nv4_extension_files`
  MODIFY `idfile` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
...
--
ALTER TABLE `nv4_users_field`
  MODIFY `fid` mediumint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `nv4_vi_modfuncs`
  MODIFY `func_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
