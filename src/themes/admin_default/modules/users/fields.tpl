...
<form class="form-inline" action="{FORM_ACTION}" method="post" id="ffields" autocomplete="off">
    <div class="table-responsive">
        ...
        <table class="table table-striped table-bordered" id="matrixfields" {DATAFORM.display_filefields}>
            ...
            <tr>
                <td colspan="2"><button type="button" class="btn btn-primary" onclick="generateMatrix('{LANG.title_column}','{LANG.title_row}','{LaNG.pls_input_rows_cols}')">{LANG.matrix_create}</button></td>
            </tr>
            </tbody>
        </table>
